...
@RestController
@RequestMapping("/api/couchbuzz-kafka")
public class CouchbuzzKafkaResource {
    private final Logger log = LoggerFactory.getLogger(CouchbuzzKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CouchbuzzKafkaResource(KafkaProperties kafkaProperties) {

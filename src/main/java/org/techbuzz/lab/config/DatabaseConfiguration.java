...
import org.techbuzz.lab.repository.CustomN1qlCouchbaseRepository;

@Configuration
@Profile("!" + JHipsterConstants.SPRING_PROFILE_CLOUD)
@EnableCouchbaseRepositories(repositoryBaseClass = CustomN1qlCouchbaseRepository.class, basePackages = "org.techbuzz.lab.repository")

...
import org.techbuzz.lab.config.KafkaProperties;
import org.testcontainers.containers.KafkaContainer;

class CouchbuzzKafkaResourceIT {
    ...
    void setup() {
        ...
        CouchbuzzKafkaResource kafkaResource = new CouchbuzzKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/couchbuzz-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/couchbuzz-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
